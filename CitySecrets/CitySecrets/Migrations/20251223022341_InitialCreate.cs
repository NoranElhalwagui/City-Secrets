        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferredPriceMin = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    PreferredPriceMax = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    PreferredMaxDistance = table.Column<double>(type: "float", nullable: true),
                    DefaultLatitude = table.Column<double>(type: "float", nullable: true),
                    DefaultLongitude = table.Column<double>(type: "float", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HiddenGemScore = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Place_Users_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Filters = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreferHiddenGems = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Favourites_Place_PlaceId",
                        column: x => x.PlaceId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlaceImages_Users_UploadedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlaceViews", x => x.ViewId);
                    table.ForeignKey(
                        name: "FK_PlaceViews_Place_PlaceId",
                        column: x => x.PlaceId,
                        principalTable: "Place",
                        principalColumn: "PlaceId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlaceViews_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Place_CategoryId_IsActive_IsDeleted",
                table: "Place",
                columns: new[] { "CategoryId", "IsActive", "IsDeleted" });

            migrationBuilder.CreateIndex(
                name: "IX_Place_CreatedByUserId",
                table: "Place",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Place_Latitude_Longitude",
                table: "Place",
                columns: new[] { "Latitude", "Longitude" });

            migrationBuilder.CreateIndex(
                name: "IX_PlaceImages_PlaceId_IsPrimary_DisplayOrder",
                table: "PlaceImages",
                columns: new[] { "PlaceId", "IsPrimary", "DisplayOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_PlaceImages_UploadedByUserId",
                table: "PlaceImages",
                column: "UploadedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PlaceViews_PlaceId_ViewedAt",
                table: "PlaceViews",
                columns: new[] { "PlaceId", "ViewedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_PlaceViews_UserId",
                table: "PlaceViews",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_PlaceId_IsApproved_IsDeleted",
                table: "Reviews",
                columns: new[] { "PlaceId", "IsApproved", "IsDeleted" });
